...
from Details import ds_course,web_course,android_course,ios_course,uiux_course
import nltk
...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='password',db='resume')
...
def run():
    ...
    if choice == 'User':
        ...
        st.image('./Logo/topimage.png', width=700)
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                ### Score
                st.success('** Your Resume Predicted Score: ' + str(score)+'**')
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Project - AI RESUME PARSER**")

        st.markdown('''

        <p align='justify'>
            Our innovative tool utilizes natural language processing (NLP) to parse information from resumes, identifying and extracting key terms such as skills, experiences, and education. These keywords are then clustered into relevant sectors using machine learning algorithms like Support Vector Machine (SVM) and K-Nearest Neighbors (KNN). The tool provides insightful recommendations, predictions, and analytics based on keyword matching, helping applicants understand their strengths and identify potential job opportunities that align with their expertise.
        </p>
